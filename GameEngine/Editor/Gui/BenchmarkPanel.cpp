...
void BenchmarkPanel::RenderGuiTimes(std::unordered_map<std::type_index, double>& averagePanelTime)
{
	if (ImGui::CollapsingHeader(TITLE_BP("Render Gui Stats")))
	{
		...
		ImGui::SameLine();
		ImGui::TextColored(ImVec4(0.75, 0.75, 0.75, 1), "%f us", averagePanelTime[Unique::typeIndex<FilesystemPanel>()]);

		ImGui::Text("ConsolePanel = ");
		ImGui::SameLine();
		ImGui::TextColored(ImVec4(0.75, 0.75, 0.75, 1), "%f us", averagePanelTime[Unique::typeIndex<ConsolePanel>()]);

		ImGui::Text("EntitiesPanel = ");
		ImGui::SameLine();
		ImGui::TextColored(ImVec4(0.75, 0.75, 0.75, 1), "%f us", averagePanelTime[Unique::typeIndex<EntitiesPanel>()]);

		ImGui::Text("ComponentPanel = ");
		ImGui::SameLine();
		ImGui::TextColored(ImVec4(0.75, 0.75, 0.75, 1), "%f us", averagePanelTime[Unique::typeIndex<ComponentPanel>()]);

		ImGui::Text("ViewportPanel = ");
		ImGui::SameLine();
		ImGui::TextColored(ImVec4(0.75, 0.75, 0.75, 1), "%f us", averagePanelTime[Unique::typeIndex<ViewportPanel>()]);
	}
}